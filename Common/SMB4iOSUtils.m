...
+ (NSData *) sockaddrFromAddress:(NSString *)address
{
	...
	return [SMB4iOSUtils sockaddrFromHost:[args objectAtIndex:0] port:[[args objectAtIndex:1] intValue]];
}
...
{
	[SMB4iOSUtils logData:data byteLimit:1000];
}
